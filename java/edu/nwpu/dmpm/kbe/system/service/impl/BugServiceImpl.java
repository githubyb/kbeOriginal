...
import edu.nwpu.dmpm.kbe.common.util.ClobUtil;
...
import edu.nwpu.dmpm.kbe.system.pageModel.Bug;
import edu.nwpu.dmpm.kbe.system.pageModel.PageHelper;
import edu.nwpu.dmpm.kbe.system.service.BugService;
...
public class BugServiceImpl implements BugService {
	...
	public void add(Bug bug) {
		...
		Tbugtype tt=bugTypeDao.getById(bug.getTypeId());
		t.setTbugtype(tt);
