...
public class InitServiceImpl implements InitService {
	...
	private void initResource() {
		...
		zyglTreeGrid.setIcon("icon-wrench");
		...
		zyglAddPage.setIcon("icon-wrench");
		...
		zyglEditPage.setIcon("icon-wrench");
		...
		wjgl.setSeq(6);
		wjgl.setUrl("");
		wjgl.setIcon("icon-server-database");
		...
		userCreateDatetimeChart.setIcon("icon-chart-curve");
	...
	private void initUser() {
		List<Tuser> l = userDao.find("from Tuser t where t.name in ('superadmin','admin1','admin2','admin3','admin4','admin5','guest')");
		if (l != null && l.size() > 0) {
			for (Tuser user : l) {
				userDao.delete(user);
			}
		...
		admin.setPwd(MD5Util.md5("superadmin"));
		admin.setCreatedatetime(new Date());
		admin.getTroles().addAll(roleDao.find("from Trole t"));// 给用户赋予所有角色
		admin.setLoginTime(0);
		admin.setActive(1);
		userDao.saveOrUpdate(admin);

		Tuser admin1 = new Tuser();
		admin1.setId("1");
		admin1.setName("resourceadmin");
		admin1.setPwd(MD5Util.md5("resourceadmin"));
		admin1.setActive(1);
		...
		admin2.setId("2");
		admin2.setName("roleadmin");
		admin2.setPwd(MD5Util.md5("roleadmin"));
		admin2.setActive(1);
		...
		admin3.setId("3");
		admin3.setName("useradmin");
		admin3.setPwd(MD5Util.md5("useradmin"));
		admin3.setActive(1);
		...
		admin4.setId("4");
		admin4.setName("dataadmin");
		admin4.setPwd(MD5Util.md5("dataadmin"));
		admin4.setActive(1);
		...
		admin5.setId("5");
		admin5.setName("bugadmin");
		admin5.setPwd(MD5Util.md5("bugadmin"));
		admin5.setActive(1);
		...
		guest.setId("guest");
		guest.setName("guest");
		guest.setPwd(MD5Util.md5("guest"));
		guest.setActive(1);
