...
<html>
<head>
<title>数字化工艺制造过程管理平台</title>
<jsp:include page="inc.jsp"></jsp:include>
<script type="text/javascript">

var sessionInfo_userId = '${sessionInfo.id}';

//如果没有登陆，直接转向login.jsp
...
<body>
	<div id="index_layout">
		<div data-options="region:'north',href:'${pageContext.request.contextPath}/layout/north.jsp'" style="height: 48px; overflow: hidden;"></div>
		<div data-options="region:'west',href:'${pageContext.request.contextPath}/layout/west.jsp',split:true" title="功能导航" style="width: 150px; overflow: hidden;padding:8px"></div>
		<div data-options="region:'center'" title="欢迎使用[xxxx信息管理系统]" style="overflow: hidden;">
	...
	<div id="index_tabsMenu" style="width: 100px; display: none;">
		<div title="refresh" data-options="iconCls:'icon-reload'">刷新</div>
		<div class="menu-sep"></div>
		<div title="close" data-options="iconCls:'icon-close'">关闭</div>
		<div title="closeOther" data-options="iconCls:'icon-closeAll'">关闭其他</div>
		<div title="closeAll" data-options="iconCls:'icon-closeAll'">关闭所有</div>
	</div>
