...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/userSafetyController/grant',
			onSubmit : function() {
		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th>所属角色</th>
					<td><select id="roleIds" name="roleIds" style="width: 140px; height: 29px;"></select><img src="${pageContext.request.contextPath}/jslib/jquery-easyui-1.3.2/themes/images/cut.png" onclick="$('#roleIds').combotree('clear');" /></td>
				</tr>
			</table>
		</form>
	</div>
