		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<th>上级角色</th>
					<td><select id="pid" name="pid" style="width: 140px; height: 29px;"></select><img src="${pageContext.request.contextPath}/jslib/jquery-easyui-1.3.2/themes/images/cut.png" onclick="$('#pid').combotree('clear');" /></td>
				</tr>
				<tr>
					<th>备注</th>
