	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				...
				<tr>
				<th>姓名</th> 
					<td><input name="displayName" type="text" placeholder="请输入姓名" class="easyui-validatebox span2" data-options="required:true"></td>
				</tr>
				<tr> 
				    <th>缩写</th>
					<td><input name="abbreviation" type="text" placeholder="请输入姓名缩写" class="easyui-validatebox span2" data-options="required:true"></td>
				</tr>
				<tr>
					<th>密码</th>
