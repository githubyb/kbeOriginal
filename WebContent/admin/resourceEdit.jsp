	...
	$(function() {
		$('#iconCls').combobox({
			...
			formatter : function(v) {
				return $.formatString('<span class="{0}" style="display:inline-block;vertical-align:middle;width:16px;height:16px;"></span>{1}', v.value, v.text);
			},
		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th>动作名称</th>
					<td>
					<input name="id" type="hidden" class="span2" value="${resource.id}" readonly="readonly" hidden="true">
					<input name="op" type="text" placeholder="请输入动作名称" class="easyui-validatebox span2"  value="${resource.op}">
					</td>
				</tr>
				<tr>
					<th>资源路径</th>
				...
				<tr>
					...
					<a class="icon-clear" onclick="$('#pid').combotree('clear');"  title="清空"></a>
					</td>
				</tr>
				<tr>
					<th>菜单图标</th>
